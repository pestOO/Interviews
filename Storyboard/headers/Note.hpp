 ...
 * 	- text: "Implement a unit test for the class Traceplayer of the spark
 * core framework."
...
const Note::TTitle &Note::getTitle() const { return iTitle; }
...
const Note::TTagContainer &Note::getTags() const { return iTags; }
